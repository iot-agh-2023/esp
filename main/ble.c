...
#define PROFILE_SENSOR_APP_ID 0
...
static void gatts_profile_sensor_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gl_profile_tab[PROFILE_SENSOR_APP_ID].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_TEST_A;
        ...
        adv_config_done |= scan_rsp_config_flag;
        esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[PROFILE_SENSOR_APP_ID].service_id, GATTS_NUM_HANDLE_TEST_A);
        break;
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        if (!param->write.is_prep){
            ...
            if (gl_profile_tab[PROFILE_SENSOR_APP_ID].descr_handle == param->write.handle && param->write.len == 2){
                ...
                if (descr_value == 0x0001){
                    if (a_property & ESP_GATT_CHAR_PROP_BIT_NOTIFY){
                        ...
                        esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[PROFILE_SENSOR_APP_ID].char_handle,
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_SENSOR_APP_ID].char_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_SENSOR_APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEST_A;

        esp_ble_gatts_start_service(gl_profile_tab[PROFILE_SENSOR_APP_ID].service_handle);
        a_property = ESP_GATT_CHAR_PROP_BIT_READ | ESP_GATT_CHAR_PROP_BIT_WRITE | ESP_GATT_CHAR_PROP_BIT_NOTIFY;
        esp_err_t add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[PROFILE_SENSOR_APP_ID].service_handle, &gl_profile_tab[PROFILE_SENSOR_APP_ID].char_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        gl_profile_tab[PROFILE_SENSOR_APP_ID].char_handle = param->add_char.attr_handle;
        gl_profile_tab[PROFILE_SENSOR_APP_ID].descr_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[PROFILE_SENSOR_APP_ID].descr_uuid.uuid.uuid16 = ESP_GATT_UUID_CHAR_CLIENT_CONFIG;
        ...
        esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(gl_profile_tab[PROFILE_SENSOR_APP_ID].service_handle, &gl_profile_tab[PROFILE_SENSOR_APP_ID].descr_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_DESCR_EVT:
        gl_profile_tab[PROFILE_SENSOR_APP_ID].descr_handle = param->add_char_descr.attr_handle;
...
void init_ble(void)
{
    ...
    ret = esp_ble_gap_register_callback(gap_event_handler); // niby uzywamy gatt, ale bez gapa nie widac urzadzenia
    if (ret){
